...
u_est = torch.tensor(loadData['ue'], device=TORCH_MACHINE).float()
y_est = torch.tensor(loadData['ye'], device=TORCH_MACHINE).float()
u_val = torch.tensor(loadData['uv'], device=TORCH_MACHINE).float()
y_val = torch.tensor(loadData['yv'], device=TORCH_MACHINE).float()
...
rep_index = 11                       # Number of time to repeat experiment
...
FOLDER_HEAD = './MLP/'
folder = FOLDER_HEAD + 'DRY_results_layers_' + str(layers) + '_units_' + \
...
# ax.set_title('Input Benchmark Dataset for DRY Model Estimation')
ax.set_ylabel(r'resistor voltage [V]')
ax.set_xlabel(r'time [s]')
ax.legend(loc='upper right')
fig_est_input.subplots_adjust(left=0.15, bottom=0.12, right=0.9,
                          top=0.9, wspace=0.3, hspace=0.2)
plt.savefig("./figures/dry_input_estimation_data.pdf")
...
ax.grid(True, 'major', 'x')
# ax.set_title(' Input Benchmark Dataset for DRY Model Validation')
ax.set_ylabel(r'resistor voltage [V]')
ax.set_xlabel(r'time [s]')
ax.legend(loc='upper right')
fig_val_input.subplots_adjust(left=0.15, bottom=0.12, right=0.9,
                          top=0.9, wspace=0.3, hspace=0.2)
plt.savefig("./figures/dry_input_validation_data.pdf")
...
ax.grid(True, 'major', 'x')
ax.grid(True, 'both', 'y')
# ax.set_title('One Step Ahead prediction results for DRY Benchmark.')
ax.set_ylabel(r'thermocouple measurement [V]')
ax.set_xlabel(r'time [s]')
ax.legend(loc='upper right')
fig_mlp0.subplots_adjust(left=0.15, bottom=0.12, right=0.9,
                    top=0.9, wspace=0.3, hspace=0.2)
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_mlp_pred_results_" + name + ".pdf")
...
fig_mlp1.subplots_adjust(left=0.15, bottom=0.12, right=0.9,
                         top=0.9, wspace=0.3, hspace=0.2)
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_mlp_sim_results_" + name + ".pdf")
...
fig_mlp2.subplots_adjust(left=0.12, bottom=0.12, right=0.88,
                         top=0.9, wspace=0.3, hspace=0.2)
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_mlp_training_progress_" + name + ".pdf")

######################### Plot Validation Progress ##########################
fig_mlp3 = plt.figure(figsize=[7, 4])
ax = fig_mlp3.add_subplot(1, 1, 1)
ax.axis([0, len(pred_vals), 0, 0.14])
...
fig_mlp3.subplots_adjust(left=0.12, bottom=0.12, right=0.88,
                         top=0.9, wspace=0.3, hspace=0.2)
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_mlp_validation_progress_" + name + ".pdf")
...
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_mlp_sparse_model_" + name + ".pdf")
...
rep_index = 14                       # Number of time to repeat experiment
layers = 1                           # Number of hidden layers
...
ax.grid(True, 'major', 'x')
ax.grid(True, 'both', 'y')
# ax.set_title('One Step Ahead prediction results of DRY dataset.')
ax.set_ylabel(r'thermocouple measurement [V]')
ax.set_xlabel(r'time [s]')
ax.legend(loc='upper right')
fig_lstm0.subplots_adjust(left=0.15, bottom=0.12, right=0.9,
                    top=0.9, wspace=0.3, hspace=0.2)
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_lstm_pred_results_" + name + ".pdf")
...
fig_lstm1.subplots_adjust(left=0.15, bottom=0.12, right=0.9,
                          top=0.9, wspace=0.3, hspace=0.2)
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_lstm_sim_results_" + name + ".pdf")
...
fig_lstm2.subplots_adjust(left=0.12, bottom=0.12, right=0.88,
                          top=0.9, wspace=0.3, hspace=0.2)
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_lstm_training_progress_" + name + ".pdf")
...
fig_lstm3.subplots_adjust(left=0.12, bottom=0.12, right=0.88,
                          top=0.9, wspace=0.3, hspace=0.2)
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_lstm_validation_progress_" + name + ".pdf")
...
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_lstm_sparse_model_" + name + ".pdf")
...
ax.grid(True, 'major', 'x')
ax.grid(True, 'both', 'y')
# ax.set_title('Simulation Comparison of DRY validation dataset.')
ax.set_ylabel(r'thermocouple measurement [V]')
ax.set_xlabel(r'time [s]')
ax.legend(loc='upper right')
fig_sim.subplots_adjust(left=0.15, bottom=0.12, right=0.9,
                        top=0.9, wspace=0.3, hspace=0.2)
name = 'lag_' + str(lag) + '_lambda_' + str(index_lambda)
plt.savefig("./figures/dry_sim_comparison_" + name + ".pdf")