...
trainBatchSize = 3000               # Choose batch size for each train
...
uEst, yEst, uVal, yVal = lib.select_train_test_data(u, y, 3000)
...
for repIndex in range(repeatExperiment):
    ...
    # Folder and filename
    folder = FOLDER_HEAD + 'HEX_results_layers_' + str(layersN) + '_units_' + \
